...
a test accuracy of 87.9\% in approximately 52 seconds. The GA reaches 61.2\% in approximately 155
...
\begin{table}[H]
    ...
    \begin{tabular}{lcccc}
        ...
        \midrule
        GD (Adam, tuned) & 87.9\% & 0.879 & $\approx$52 & 150 epochs \\
...
GD with Adam is significantly more effective for training this MLP: 87.9\% test accuracy vs.\
...
The tuning results reinforce this: GD improved from $\approx$81\% to 91.9\% on validation
